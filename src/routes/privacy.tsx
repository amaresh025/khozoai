  ...
  component: () => (
    <div className="mx-auto max-w-3xl px-4 py-16 prose prose-invert">
      ...
      <p className="mt-4 text-muted-foreground">
        AI Tools Hub respects your privacy. We only collect the data needed to run the directory:
        optional account email, content you submit (tools, reviews, favorites), and basic analytics.
        We don't sell your data.
      </p>
      <p className="mt-4 text-muted-foreground">
        You can request deletion of your account and content at any time via{" "}
